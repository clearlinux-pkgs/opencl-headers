...
Source0  : https://github.com/KhronosGroup/OpenCL-Headers/archive/refs/tags/v2023.12.14.tar.gz
...
%prep
%setup -q -n OpenCL-Headers-2023.12.14
cd %{_builddir}/OpenCL-Headers-2023.12.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710178157
mkdir -p clr-build
pushd clr-build
